...
namespace SplitRoast.App.Services;

/// <summary>
/// Stores each game's <see cref="GameProfile"/> as a small JSON file under
/// %AppData%\SplitRoast\profiles. One file per app id keeps things simple, easy to
...
public sealed class JsonGameProfileStore : IGameProfileStore
{
    ...
    public JsonGameProfileStore()
    {
        ...
        _profilesDir = Path.Combine(appData, "SplitRoast", "profiles");
