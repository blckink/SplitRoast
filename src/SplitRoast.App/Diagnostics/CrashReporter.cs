...
namespace SplitRoast.App.Diagnostics;

/// <summary>
/// Central place for surfacing unexpected errors: writes them to
/// %AppData%/SplitRoast/crash.log and shows them in a dialog, so the app never
    ...
    public static void Report(Exception? exception, string source)
    {
        ...
        try
        {
            string dir = Path.Combine(
                Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "SplitRoast");
