...
.EXAMPLE
    powershell -ExecutionPolicy Bypass -File SplitPlay\setup.ps1
#>
[CmdletBinding()]
param([switch]$Installer)

$ErrorActionPreference = "Stop"
$Here   = $PSScriptRoot                       # ...\SplitPlay
...
if (-not (Test-Path $AppProj)) {
    ...
    Write-Host "Make sure you are running this from the 'SplitPlay' folder of the" -ForegroundColor Red
    Write-Host "'claude/steam-splitscreen-launcher-w7tEE' branch (not 'master')." -ForegroundColor Red
    exit 1
}
